...
set key left top Left reverse at screen 0.16,0.95 samplen 1.2
...
set arrow from 600,315 to 600,465 head filled size 25,28 lc rgb "red" lw 4

plot 'toy_bw_thrpt.txt' using 1:2 title columnheader(1)	w lp lw 4 lc rgb "blue" dt 1 ps 3 pt 7, \
